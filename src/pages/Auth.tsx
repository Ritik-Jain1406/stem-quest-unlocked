...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-science via-technology to-engineering flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/80">
            Join the adventure of learning Science, Technology, Engineering & Mathematics
          </p>
        </div>
